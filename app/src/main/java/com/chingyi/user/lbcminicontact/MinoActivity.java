...
public class MinoActivity extends AppCompatActivity {

    private RecyclerView mRecycleList;

    private DatabaseReference mUserDatabase;
    private AlertDialog.Builder build;
    private FirebaseRecyclerAdapter<Users, MinoActivity.UserViewHolder> recyclerAdapter;
    private MaterialSearchView mino_MaterialSearchView;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mino_MaterialSearchView.setMenuItem(item);
        return true;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mino);

        toolbar = (Toolbar) findViewById(R.id.mino_searchToolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Mino Contacts");
        toolbar.setTitleTextColor(Color.parseColor("#FFFFFF"));

        mino_MaterialSearchView = (MaterialSearchView) findViewById(R.id.mino_materialsearchView);

        mino_MaterialSearchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            @Override
        ...
        mino_MaterialSearchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            @Override
        ...
        mUserDatabase = FirebaseDatabase.getInstance().getReference("mino");


        mUserDatabase.keepSynced(true);


        mRecycleList = (RecyclerView) findViewById(R.id.mino_mSearchListView);
    ...
    protected void onStart() {
        ...
        super.onStart();
        recyclerAdapter = new FirebaseRecyclerAdapter<Users, MinoActivity.UserViewHolder>(
                Users.class,
                R.layout.deatail_contact_view,
                MinoActivity.UserViewHolder.class,
                mUserDatabase
        ) {
            @Override
            protected void populateViewHolder(final MinoActivity.UserViewHolder viewHolder, final Users model, int position) {
                final String pos = getRef(position).getKey();
                viewHolder.setDetails(MinoActivity.this, model.getName(), model.getPhone(), model.getImage());
    ...
    public void dialogHelper(String name, final String phone)  {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(MinoActivity.this);
    ...
    public void firebaseSearch(String searchText1) {
        ...
        FirebaseRecyclerAdapter<Users, MinoActivity.UserViewHolder> recyclerAdapter1 = new FirebaseRecyclerAdapter<Users, MinoActivity.UserViewHolder>(
                Users.class,
                R.layout.deatail_contact_view,
                MinoActivity.UserViewHolder.class,
                firebaseSearchQuery
