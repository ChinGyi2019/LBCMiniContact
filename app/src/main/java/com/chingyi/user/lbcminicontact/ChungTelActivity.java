...
public class ChungTelActivity extends AppCompatActivity {

    private RecyclerView mRecycleList;

    private DatabaseReference mUserDatabase;
    private AlertDialog.Builder build;
    FirebaseRecyclerAdapter<Users,UserViewHolder> recyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chung_tel);


        mUserDatabase = FirebaseDatabase.getInstance().getReference("chungtel");
        mUserDatabase.keepSynced(true);


        toolbar = (Toolbar) findViewById(R.id.searchToolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("ChungTel Contacts");
        ...
        mRecycleList=(RecyclerView)findViewById(R.id.mSearchListView);
    ...
    protected void onStart() {
        ...
        super.onStart();
        recyclerAdapter = new FirebaseRecyclerAdapter<Users, UserViewHolder>(
                Users.class,
            ...
            protected void populateViewHolder(UserViewHolder viewHolder, final Users model, final int position) {
              final String pos = getRef(position).getKey();
                ...
                viewHolder.setDetails(ChungTelActivity.this,model.getName(),model.getPhone(),model.getImage());
    ...
    public void dialogHelper(String name, final String phone)  {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(ChungTelActivity.this);
    ...
    public void firebaseSearch(String searchText1) {
       ...
       // String lowerString = searchText.toLowerCase();
        ...
        Query firebaseSearchQuery = mUserDatabase.orderByChild("search_name").startAt(searchText).endAt(searchText + "\uf8ff");
         ...
         FirebaseRecyclerAdapter<Users,UserViewHolder>recyclerAdapter1 = new FirebaseRecyclerAdapter<Users, UserViewHolder>(
                Users.class,
                R.layout.deatail_contact_view,
                UserViewHolder.class,
                firebaseSearchQuery
