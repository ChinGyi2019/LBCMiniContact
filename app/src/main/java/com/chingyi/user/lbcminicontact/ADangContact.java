...
public class ADangContact extends AppCompatActivity {

    private RecyclerView mRecycleList;

    private DatabaseReference mUserDatabase;
    private AlertDialog.Builder build;
    FirebaseRecyclerAdapter<Users,ADangContact.UserViewHolder> recyclerAdapter;
    private MaterialSearchView other_MaterialSearchView;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        other_MaterialSearchView.setMenuItem(item);
        return  true;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adang_contact);
        mUserDatabase = FirebaseDatabase.getInstance().getReference("mdyLai");
        mUserDatabase.keepSynced(true);

        toolbar = (Toolbar) findViewById(R.id.other_searchToolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("ADang Contacts");
        toolbar.setTitleTextColor(Color.parseColor("#FFFFFF"));



        other_MaterialSearchView = (MaterialSearchView)findViewById(R.id.other_materialsearchView);

        other_MaterialSearchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            @Override
        ...
        other_MaterialSearchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            @Override
        ...
        mRecycleList=(RecyclerView)findViewById(R.id.other_mSearchListView);
    ...
    protected void onStart() {
        ...
        super.onStart();
        recyclerAdapter = new FirebaseRecyclerAdapter<Users, ADangContact.UserViewHolder>(
                Users.class,
                R.layout.deatail_contact_view,
                ADangContact.UserViewHolder.class,
                mUserDatabase
        ) {
            @Override
            protected void populateViewHolder(ADangContact.UserViewHolder viewHolder, final Users model, int position) {
                final String pos = getRef(position).getKey();
                viewHolder.setDetails(ADangContact.this,model.getName(),model.getPhone(),model.getImage());
    ...
    public void dialogHelper(String name, final String phone)  {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(ADangContact.this);
    ...
    public void firebaseSearch(String searchText1) {
        ...
        FirebaseRecyclerAdapter<Users,ADangContact.UserViewHolder>recyclerAdapter1 = new FirebaseRecyclerAdapter<Users, ADangContact.UserViewHolder>(
                Users.class,
                R.layout.deatail_contact_view,
                ADangContact.UserViewHolder.class,
                firebaseSearchQuery
